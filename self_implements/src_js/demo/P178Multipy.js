...
export default class P178Multipy extends JWebglDemoInstance {
    constructor() {
        super(...arguments);
        /**
         * 顶点数据
    ...
    onDraw() {
        this.program.u_Sampler0.fill(`./resources/sky.jpg`);
        this.program.u_Sampler1.fill(`./resources/circle.gif`);
        this.program.drawArrays(JWebglEnum.DrawArraysMode.TRIANGLE_STRIP, this.vertices);
    }
}
__decorate([
    JWebglDemoInstance.program(Program)
], P178Multipy.prototype, "program", void 0);
