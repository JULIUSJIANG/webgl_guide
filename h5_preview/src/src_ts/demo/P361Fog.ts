import JWebglDefine from "../common/JWebglDefine";
...
import JWebglProgramUniformVec2 from "../common/JWebglProgramUniformVec2";
...
import JWebglProgramVarying from "../common/JWebglProgramVarying";
